...
function AboutMe() {
  return (
    <article className="z-90 flex flex-col relative gap-medium  p-10 rounded-3xl lg:grid lg:grid-cols-7 lg:grid-rows-[auto_12rem_18rem] lg:px-negative">
        ...
        <section className="lg:col-start-1 lg:col-end-3 lg:h-full hidden lg:flex">
          <Image
            width={512}
            height={512}
            src="/img/pictures/portrait.avif"
        ...
        <section className="lg:col-start-3 lg:col-span-full lg:row-start-1 bg-primary-1 p-medium brown-shadow rounded-2xl">
        ...
        <section className="lg:col-span-2 lg:row-start-2 hidden items-center justify-center rounded-2xl gap-medium bg-primary-1 p-medium brown-shadow">
          <Image
            width={500}
            height={500}
        ...
        <section className="col-span-2 items-center justify-center rounded-2xl gap-medium bg-primary-1 p-medium brown-shadow">
          <Image
            width={500}
            height={500}
            src="/img/shapes/moon.png"
        ...
        <a className="col-start-3 col-span-full bg-primary-1 p-medium text-h3 font-header brown-shadow rounded-2xl flex flex-col justify-between text-left">
