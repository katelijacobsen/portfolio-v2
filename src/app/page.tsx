...
const cards = [
  {
    ...
    description:
      "For the group final exam project, I was responsible for illustrations, UI/UX design, SEO, designsystem and backend development, including i18n configuration and database management with Supabase. I helped create a user-friendly interface supported by effective data management.",
  },
  {
    title: "Ducky's Diner",
    slug: "duckys-diner",
