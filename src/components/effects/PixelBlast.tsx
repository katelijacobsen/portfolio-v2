...
/**
 * Vendored WebGL background effect (three.js + postprocessing).
 *
 * Third-party code kept as-is on purpose: treat it as a black box and change
 * its behaviour through props rather than by editing the shader internals.
 * Always load it via `next/dynamic` with `ssr: false`; it needs a real canvas.
 */
