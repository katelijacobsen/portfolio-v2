...
/**
 * Every portfolio project, in the order they appear in the card stack.
 *
 * Adding a project = appending one entry here; the home page, the card stack,
 * the overlay and the /projects/[slug] route all read from this list.
 */
export const projects: Project[] = [
  {
    ...
    tag: "website",
    description: "3RD semester project focusing on building user friendly ticket booking-system",
    image: "/img/pictures/foofest-festival.avif",
    site: "https://foo-fest-optimized.vercel.app/",
    figmaLink: "https://www.figma.com/design/xVN4uIsDjVVUeFp7YwFQkp/Foo-Fest?node-id=0-1&t=L5vHaTjijK4zmU7T-1",
    overview:
    ...
    mockups: [
      { src: "/img/pictures/foofest-mockup.avif", alt: "FooFest Festival mockup" },
      { src: "/img/pictures/foofest-mockup2.avif", alt: "FooFest Festival mockup" },
    ],
  },
  {
    slug: "girltalk",
  ...
  },
  {
    ...
    mockups: [
      { src: "/img/pictures/duckysDiner-mockup.avif", alt: "Ducky's Diner mockup" },
      { src: "/img/pictures/duckysDiner-mockup-1.avif", alt: "Ducky's Diner mockup" },
    ],
  },
  {
    slug: "kaer-kaffebar",
    ...
    figmaLink: "https://www.figma.com/design/q3uIyBx3GutWyuzmBWtpXU/K%C3%A6r-Kaffebar--Backup-?node-id=1-8&t=C6Mr8wx23pBzJ3d7-1",
    overview:
    ...
    mockups: [
      { src: "/img/pictures/kaer-mockup.avif", alt: "Kær Kaffebar mockup" },
      { src: "/img/pictures/kaer-mockup-2.avif", alt: "Kær Kaffebar mockup" },
    ],
  },
  {
    slug: "madhovedet",
